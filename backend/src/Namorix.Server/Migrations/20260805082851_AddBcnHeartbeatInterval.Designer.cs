...
namespace Namorix.Server.Migrations
{
    ...
    [Migration("20260805082851_AddBcnHeartbeatInterval")]
    partial class AddBcnHeartbeatInterval
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FgCertificateDomain", b =>
                {
            ...
            modelBuilder.Entity("Namorix.Server.Models.AddonCatalogEntry", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Namorix.Server.Models.AddonInstallation", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Namorix.Server.Models.BcnActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Namorix.Server.Models.BcnHostname", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(32)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Namorix.Server.Models.BcnSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Namorix.Server.Models.BcnActivityLog", b =>
                {
                    b.HasOne("Namorix.Server.Models.BcnHostname", "Hostname")
                        .WithMany()
