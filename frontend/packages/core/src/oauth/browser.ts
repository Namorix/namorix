...
export interface OAuthService {
  ...
  clearTokens(): void
  trySilentRefresh(desktopUrl?: string): Promise<OAuthToken | null>
}
...
export function createOauth(core: NmxCoreClient): OAuthService {
  ...
  async function trySilentRefresh(
    ...
    try {
      const baseUrl = desktopUrl ?? core.getApiBaseUrl()
