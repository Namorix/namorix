...
export interface ThemeService {
  restoreTheme(): void
  loadTheme(cssId: string, cssPath: string, elementId?: string): Promise<void>
  applyTheme(themeId: string): Promise<void>
  applyAppearanceTokens(settings: AppearanceSettings): void
}
...
export function createThemeLoader(core: NmxCoreClient): ThemeService {
  ...
  function applyAppearanceTokens(settings: AppearanceSettings) {
  ...
  return { restoreTheme, loadTheme, applyTheme, applyAppearanceTokens }
}
