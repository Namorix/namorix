...
//     dispatch(setAddonInstalling(true))
//     setError(null)
//     try {
//       await addonController.install({
//         image: image.trim(),
//         displayName: displayName.trim() || undefined,
//         hostPort: hostPort ? Number(hostPort) : 0,
//       })
//       setImage("")
//       setDisplayName("")
//       setHostPort("")
...
//       // Refresh list
//       const data = await addonController.list()
//       dispatch(setAddons(data ?? []))
//     } catch (err) {
//       setError(err instanceof Error ? err.message : "Install failed")
//     } finally {
//       dispatch(setAddonInstalling(false))
//     }
//   }
//
...
//     <NmxAddonRoot>
//       {error && (
//         <NmxInlineAlert variant="error" onDismiss={() => setError(null)}>
//           {error}
//         </NmxInlineAlert>
//       )}
//
//       <div className="nmx-package-center__header">
//         <h2>Package Center</h2>
//         <NmxButton onClick={() => setShowInstall(!showInstall)}>
//           {showInstall ? "Cancel" : "Install Addon"}
//         </NmxButton>
//       </div>
//
//       {showInstall && (
//         <form
//           className="nmx-package-center__install-form"
//           onSubmit={handleInstall}
//         >
//           <input
//             className="nmx-input"
//             placeholder="Docker image (e.g. owner/name:tag)"
//             value={image}
...
//           />
//           <NmxButton type="submit" disabled={installing || !image.trim()}>
