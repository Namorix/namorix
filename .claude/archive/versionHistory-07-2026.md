...
|---------|---------|-----------|
| frontend | 0.69.0 | M4 (Beacon DDNS full addon, config validation + error i18n, Frontgate ACME UI updates) |
| @namorix/core | 0.54.0 | M4 (Beacon routes, ApiResponse/ApiError params field, formatCustomError field injection) |
| @namorix/styles | 0.46.0 | M4 (beacon/log-list/align SCSS, rail footer, data-table rowCellSpacing, icomoon + theme rebuild) |
| @namorix/ui | 0.36.0 | M4 (NmxLogList, NmxAlign, NmxRail footer prop, NmxDataTable rowCellSpacing, NmxFallback) |
| Namorix.Core | 0.53.0 | M4 (ApiResponse.Params additive field) |
| Namorix.Server | 0.60.0 | M4 (Beacon backend: BcnController + providers + workers + PublicIpService, Frontgate ACME middleware) |
...
Xem chi tiết tại:
- [versionHistory-08-2026.md](versionHistory-08-2026.md) — August 2026
- [versionHistory-07-2026.md](../archive/versionHistory-07-2026.md) — July 2026
- [versionHistory-06-2026.md](../archive/versionHistory-06-2026.md) — June 2026
